...
resource "harness_platform_triggers" "pr_trigger_java" {
  identifier = "devops_github_pr_trigger_java"
  org_id     = var.organization_id
  project_id = harness_platform_project.ck_project.id
...
resource "harness_platform_triggers" "merge_trigger_java" {
  identifier = "devops_github_merge_trigger_java"
  org_id     = var.organization_id
  project_id = harness_platform_project.ck_project.id
